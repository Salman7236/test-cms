...
export const createOfficeAllocation = (data) => API.post('/office-alloc/register', data);
export const updateOfficeAllocation = (id, data) => API.patch(`/office-alloc/${id}`, data);
