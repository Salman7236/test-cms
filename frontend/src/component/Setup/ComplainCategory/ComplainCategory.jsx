...
const ComplainCategory = () => {
  ...
  // FIX: Added the missing handleEdit function
    ...
    >
      ...
      >
        <Box sx={{ display: "flex", alignItems: "center", gap: 4 }}>
          <Typography
            variant="h4"
            sx={{ fontWeight: "600", color: themeColors.primary }}
          >
      ...
      <ComplainForm
        ...
        handleClose={() => {
          setOpenModal(false);
          setError("");
          setEditingCategory(null); // FIX: Clear editing state when closing modal
        }}
        initialValues={
          editingCategory || {
            name: "",
